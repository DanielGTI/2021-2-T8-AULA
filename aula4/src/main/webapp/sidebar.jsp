        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>APPA</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> Aluno <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="aluno.jsp">Informações</a></li>
                            ...
                            <li><a><i class="fa fa-edit"></i> Turma <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="turma.jsp">Cadastro de turmas</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-desktop"></i> Disciplina <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                            ...
                            <li><a><i class="fa fa-table"></i> Professor <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="tables.html">Tables</a></li>
                                    <li><a href="tables_dynamic.html">Table Dynamic</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-bar-chart-o"></i> Curso <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-windows"></i> Tópicos <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
